...
public final class OneDimAveragingPhaser {
   ...
   *
   * @param iterations The number of iterations to run
   * @param myNewParam A double array that starts as the output array
   * @param myValParam A double array that contains the initial input to the iterative averaging
   *     problem
   * @param n The size of this problem
   * @param tasks The number of threads/tasks to use to compute the solution
   */
  public static void runParallelFuzzyBarrier(
    ...
    for (int ii = 0; ii < tasks; ii++) {
      ...
      threads[ii] =
          new Thread(
              () -> {
                double[] myVal = myValParam;
                double[] myNew = myNewParam;
