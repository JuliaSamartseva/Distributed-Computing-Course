...
public final class StudentAnalytics {
  ...
  /**
   * TODO compute the average age of all actively enrolled students using parallel streams. This
   * should mirror the functionality of averageAgeOfEnrolledStudentsImperative. This method should
   * not use any loops.
   *
   * @param studentArray Student data for the class.
   * @return Average age of enrolled students
