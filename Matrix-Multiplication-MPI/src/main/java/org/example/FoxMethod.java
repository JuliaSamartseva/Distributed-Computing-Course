...
public class FoxMethod {
  ...
  public static void calculate(String[] args, int dimension) {
    ...
    for (int iter = 0; iter < gridSize; iter++) {
      ...
      if (gridCoords[0] == gridSize - 1) nextProcess = 0;
      int previousProcess = gridCoords[0] - 1;
      if (gridCoords[0] == 0) previousProcess = gridSize - 1;

      ColComm.Sendrecv_replace(
          BlockB, 0, blockSize * blockSize, MPI.INT, nextProcess, 0, previousProcess, 0);
    }
